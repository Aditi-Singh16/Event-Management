...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
    <center><h1 class="title">VESIT Event Dashboard</h1>
    <div class="wrapper">
        <div class="divimage">
            <img src="https://schoolbook.getmyuni.com/assets/images/rev_img/5212__1970/14290069515.jpg">
        </div>
        <div class="divtext">Life is an Event. Make it Memorable.<br>
                We create you celebrate.</div>
    </div></center>
    </div>
    <!-- horizontal line
    <center><hr class='line'>
    <hr class='line1'></center> -->
